...
conn.sendHydrated2(m.chat, `DONE:` + ' ' + name, cap, x.result.Normal_video, 'https://instagram.com/kashikoi.ai', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', 'https://youtube.com/UCHIModder', 'ʏ ᴏ ᴜ ᴛ ᴜ ʙ ᴇ', [['Donasi', `.donasi`],
  ['Owner', `.owner`]], m)
}
