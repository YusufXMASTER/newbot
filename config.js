...
global.sgh = '-' // github
global.sgc = 'https://chat.whatsapp.com/KGjRvZdmo7pCFC2qyqPkDB' // group whatsapp
global.sdc = '-'//discord
global.snh = 'https://youtu.be/saHDNp29OF8' // my youtube channel
global.sfb = '-' // facebook
global.syt = '-'
global.tik = '-' 
global.tautanwa = 'https://wa.me/6285770017326'
global.wame = 'https://wa.me/6285770017326' // kalau gk punya bisa ganti pake gini wa.me/6283133329293

/*============== PAYMENT ==============*/
global.pdana = '0857 7001 7326' //dana
global.povo = '-' //ovo
global.pgopay = '-' //gopay
global.plinkaja = '-' //link aja
global.ppulsa = '085770017326' //telkomsel
global.ppulsa2 = '085770017326' // kalau ada kartu lain isi aja
global.psaweria = '-'

/*============== NOMOR ==============*/
global.nomorbot = '-?' //Jangan Lupa diganti
global.nomorown = '6285770017326'
global.nomorown1 = '6285770017326' //pake No Pacar lo Juga Boleh
global.namebot = 'KASHIKOI MD'
global.nameown = '卐 YUSUF 卐'
global.nameown1 = '卐 YUSUF 卐' //Pake Nama Pacar Lo Juga Boleh

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ INFO BIO DATA OWN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://www.instagram.com/kashikoi.ai/' // ig lo
global.sigpcr = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://www.instagram.com/iam.isanime/' // ig cewek lo
/*============== Github Thanks To ==============*/
...
/*============== WATERMARK ==============*/
global.gcname = 'KASHIKOI.AI MD'//nama group kalian
global.readMore = readMore
global.wm = '                「 KASHIKOI.AI MD 」'
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘KASHIKOI.AI MD ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ KASHIKOI.AI MD '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By 卐 YUSUF 卐 `
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '              「 KASHIKOI.AI MD  あ」'
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
global.danied = pickRandom(["✘ 𝗘𝗿𝗼𝗿 𝟰𝟬𝟰","𝘼𝙠𝙨𝙚𝙨 𝘿𝙞𝙩𝙤𝙡𝙖𝙠","⚠️ 𝘼𝙘𝙘𝙨𝙚𝙨 𝘿𝙖𝙣𝙞𝙚𝙙 ⚠️"])

/*============== STICKER WM ==============*/
global.stickpack = 'KASHIKOI.AI MD'
global.stickauth = `By 卐 YUSUF 卐`
...
global.urlnya = "https://www.instagram.com/kashikoi.ai/"
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = '0857-7001-7326'
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ JNGN DI UBAH ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
